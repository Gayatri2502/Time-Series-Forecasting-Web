...
class Rotation:
    ...
    @classmethod
    def from_euler(cls, seq: str, angles: float | npt.ArrayLike,
    ...
    def approx_equal(self, other: Rotation, atol: float | None,
                     degrees: bool = ...) -> np.ndarray | bool: ...

    def mean(self, weights: npt.ArrayLike | None = ...) -> Rotation: ...

    def reduce(self, left: Rotation | None = ..., right: Rotation | None = ...,
               return_indices: bool = ...) -> Rotation | tuple[
