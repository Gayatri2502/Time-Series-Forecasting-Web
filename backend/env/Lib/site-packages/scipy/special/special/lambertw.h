...
namespace special {
    ...
    namespace detail {
        ...
        lambertw_asy(std::complex<double> z, long k) {
    ...
    SPECFUN_HOST_DEVICE inline std::complex<double>
    lambertw(std::complex<double> z, long k, double tol) {
        double absz;
        ...
        set_error("lambertw", SF_ERROR_SLOW, "iteration failed to converge: %g + %gj", z.real(),
                  z.imag());
