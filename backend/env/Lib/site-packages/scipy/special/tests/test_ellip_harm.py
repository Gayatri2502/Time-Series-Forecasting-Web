...
def test_ellip_norm():
    ...
    def G32(h2, k2):
        res = (16 * (h2 ** 4 + k2 ** 4) - 36 * h2 * k2 * (
                h2 ** 2 + k2 ** 2) + 46 * h2 ** 2 * k2 ** 2
    ...
    def G34(h2, k2):
        res = (
                6 * h2 ** 4 + 16 * k2 ** 4 - 12 * h2 ** 3 * k2 - 28 * h2 * k2 ** 3 + 34 * h2 ** 2 * k2 ** 2
                + sqrt(h2 ** 2 + 4 * k2 ** 2 - h2 * k2) * (
                        -6 * h2 ** 3 - 8 * k2 ** 3 + 9 * h2 ** 2 * k2 +
                        13 * h2 * k2 ** 2))
    ...
    def G36(h2, k2):
        res = (
                16 * h2 ** 4 + 6 * k2 ** 4 - 28 * h2 ** 3 * k2 - 12 * h2 * k2 ** 3 + 34 * h2 ** 2 * k2 ** 2
                + sqrt(4 * h2 ** 2 + k2 ** 2 - h2 * k2) * (
                        -8 * h2 ** 3 - 6 * k2 ** 3 + 13 * h2 ** 2 * k2 +
                        9 * h2 * k2 ** 2))
