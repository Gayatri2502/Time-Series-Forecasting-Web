                    ...
                    if ((dtypes == "all"
                         ...
                         or dtypes == "floating" and a.dtype in _floating_dtypes
                            ...
                            and (a.dtype in _boolean_dtypes and type(s) == bool
                                 ...
                                 or a.dtype in _complex_floating_dtypes and type(s) in [complex,
                                                                                        float, int]
                            )):
                    ...
                    for x in _array_vals():
                        for y in _array_vals():
                            ...
                            # Ensure only those dtypes that are required for every operator are allowed.
                                    ...
                                    x.dtype in _boolean_dtypes and y.dtype in _boolean_dtypes
                                  ...
                                  or (
                                          dtypes == "numeric" and x.dtype in _numeric_dtypes and y.dtype in _numeric_dtypes)
