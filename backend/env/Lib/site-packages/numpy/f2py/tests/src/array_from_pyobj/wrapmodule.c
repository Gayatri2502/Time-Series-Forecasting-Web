...
static PyObject *f2py_rout_wrap_call(PyObject *capi_self,
    ...
    capi_arr_tmp = ndarray_from_pyobj(type_num, elsize, dims, rank, intent | F2PY_INTENT_OUT,
                                      arr_capi, "wrap.call failed");
...
PyMODINIT_FUNC PyInit_test_array_from_pyobj_ext(void) {
    ...
    s = PyUnicode_FromString(
            "This module 'wrap' is auto-generated with f2py (version:2_1330).\nFunctions:\n"
            "  arr = call(type_num,dims,intent,obj)\n"
            ".");
