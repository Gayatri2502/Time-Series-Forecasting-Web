...
class MNLogit(MultinomialModel):
    ...
    def hessian(self, params):
        ...
        H = np.transpose(H.reshape(J - 1, J - 1, K, K), (0, 2, 1, 3)).reshape((J - 1) * K,
                                                                              (J - 1) * K)
        return H
...
class OrderedResults(DiscreteResults):
    __doc__ = _discrete_results_docs % {
        "one_line_description": "A results class for ordered discrete data.", "extra_attr": ""}
    pass


class BinaryResults(DiscreteResults):
    __doc__ = _discrete_results_docs % {"one_line_description": "A results class for binary data",
                                        "extra_attr": ""}
